...
class Init_VehicleTorqueSetpoint_yaw_trim
{
public:
  explicit Init_VehicleTorqueSetpoint_yaw_trim(::px4_msgs::msg::VehicleTorqueSetpoint & msg)
  : msg_(msg)
  {}
  ::px4_msgs::msg::VehicleTorqueSetpoint yaw_trim(::px4_msgs::msg::VehicleTorqueSetpoint::_yaw_trim_type arg)
  {
    msg_.yaw_trim = std::move(arg);
...
public:
  ...
  : msg_(msg)
  {}
  Init_VehicleTorqueSetpoint_yaw_trim xyz(::px4_msgs::msg::VehicleTorqueSetpoint::_xyz_type arg)
  {
    msg_.xyz = std::move(arg);
    return Init_VehicleTorqueSetpoint_yaw_trim(msg_);
  }
