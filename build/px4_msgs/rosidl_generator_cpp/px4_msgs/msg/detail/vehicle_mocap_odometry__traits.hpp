  ...
  std::ostream & out)
{
  ...
  // member: angular_velocity_variance
  {
    if (msg.angular_velocity_variance.size() == 0) {
      out << "angular_velocity_variance: []";
    } else {
      out << "angular_velocity_variance: [";
      size_t pending_items = msg.angular_velocity_variance.size();
      for (auto item : msg.angular_velocity_variance) {
        rosidl_generator_traits::value_to_yaml(item, out);
        if (--pending_items > 0) {
          out << ", ";
        }
  ...
  {
    out << "quality_flag: ";
    rosidl_generator_traits::value_to_yaml(msg.quality_flag, out);
  }
  out << "}";
